...
# CAMERA_TYPE = "MAP"
MAP_BASE_IMAGE_PATH = 'parts/VisionGenerator/1x1_landscape.jpg'
# IMAGE_W = 160
# IMAGE_H = 120
...
DRIVE_TRAIN_TYPE="THREE_MOTORS_PIGPIO"
# 
# #STEERING
...
# THREE_MOTORS_PIGPIO - original TA7291P Motor Driver
# RIGHT MOTOR
...
LEFT_MOTOR_IN1_GPIO = 19 #13 #26
LEFT_MOTOR_IN2_GPIO = 13 #19
...
PI_HOSTNAME = "192.168.8.132"   # the network hostname or ip address
...
JOYSTICK_MAX_THROTTLE = 1.0 # for throttle and lift
...
JOYSTICK_STEERING_DIR = -1.0
# use in forklift_jpystick.py
JOYSTICK_LIFT_THROTTLE_DIR = -1.0
JOYSTICK_MAX_LIFT_THROTTLE = 1.0
# joystick push test 
#JOYSTICK_DEBUG = True
# joystick normal use
