...
def _pub_base_topic(system, thing_type, thing_group, thing_name, message_type, data_type):
    """
    Publisher用のトピック文字列を返却する。
    引数：
        system          システムの種類
        thing_type      モノのタイプ
        thing_group     モノのグループ
...
def pub_tub_json_topic(system, thing_type, thing_group, thing_name):
    """
    Tubデータ(辞書型)をPublishする際に使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
        thing_group モノのグループ
...
def pub_mpu9250_json_topic(system, thing_type, thing_group, thing_name):
    """
    MPU9250データ(辞書型)をPublishする際に使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
        thing_group モノのグループ
...
def pub_mpu6050_json_topic(system, thing_type, thing_group, thing_name):
    """
    MPU6050データ(辞書型)をPublishする際に使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
        thing_group モノのグループ
...
def pub_hedge_usnav_json_topic(system, thing_type, thing_group, thing_name):
    """
    Marvelmindデータ(辞書型、位置情報のみ)をPublishする際に
    使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
...
def pub_hedge_usnav_raw_json_topic(system, thing_type, thing_group, thing_name):
    """
    Marvelmindデータ(辞書型、距離情報のみ)をPublishする際に
    使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
...
def pub_hedge_imu_json_topic(system, thing_type, thing_group, thing_name):
    """
    Marvelmindデータ(辞書型、IMU情報のみ)をPublishする際に
    使用するトピック名を返却する。
    引数：
        system      システムの種類
        thing_type  モノのタイプ
